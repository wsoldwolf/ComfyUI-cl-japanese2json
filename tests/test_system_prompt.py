...
class SystemPromptTests(unittest.TestCase):
    ...
    def test_real_prompt_contains_required_transport_rules(self) -> None:
        ...
        self.assertIn("SUB descriptive introduction", prompt)
        self.assertIn("A later SUB sentence may be an instruction or prohibition", prompt)
        self.assertIn("put the English negation BEFORE", prompt)
